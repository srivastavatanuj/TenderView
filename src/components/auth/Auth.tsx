...
const Auth = () => {
  ...
  return (
    <div className="container relative flex pt-0 sm:pt-20 flex-col items-center justify-center lg:px-0">
      <div className="rounded-xl bg-white sm:w-[450px] pb-12 shadow-0 sm:shadow-[0_7px_29px_0px_rgb(100,100,111,0.2)]">
